...
type ItemCategoryRequest_Tool int32

const (
	// https://ascii.jp/elem/000/004/124/4124022/
	ItemCategoryRequest_Gen_1        ItemCategoryRequest_Tool = 0
	ItemCategoryRequest_Imagen_Video ItemCategoryRequest_Tool = 1
	ItemCategoryRequest_Make_Video   ItemCategoryRequest_Tool = 2
	ItemCategoryRequest_Versy        ItemCategoryRequest_Tool = 3
)

// Enum value maps for ItemCategoryRequest_Tool.
var (
	ItemCategoryRequest_Tool_name = map[int32]string{
		0: "Gen_1",
		1: "Imagen_Video",
		2: "Make_Video",
		3: "Versy",
	}
	ItemCategoryRequest_Tool_value = map[string]int32{
		"Gen_1":        0,
		"Imagen_Video": 1,
		"Make_Video":   2,
		"Versy":        3,
...
func (x ItemCategoryRequest_Tool) Enum() *ItemCategoryRequest_Tool {
	p := new(ItemCategoryRequest_Tool)
	*p = x
	return p
}

func (x ItemCategoryRequest_Tool) String() string {
	return protoimpl.X.EnumStringOf(x.Descriptor(), protoreflect.EnumNumber(x))
}

func (ItemCategoryRequest_Tool) Descriptor() protoreflect.EnumDescriptor {
	return file_item_proto_enumTypes[3].Descriptor()
}

func (ItemCategoryRequest_Tool) Type() protoreflect.EnumType {
	return &file_item_proto_enumTypes[3]
}

func (x ItemCategoryRequest_Tool) Number() protoreflect.EnumNumber {
	return protoreflect.EnumNumber(x)
}

// Deprecated: Use ItemCategoryRequest_Tool.Descriptor instead.
func (ItemCategoryRequest_Tool) EnumDescriptor() ([]byte, []int) {
	return file_item_proto_rawDescGZIP(), []int{9, 0}
}

type ItemCategoryRequest_Category int32

const (
	ItemCategoryRequest_YOUTUBE   ItemCategoryRequest_Category = 0
	ItemCategoryRequest_TWITTER   ItemCategoryRequest_Category = 1
	ItemCategoryRequest_INSTAGRAM ItemCategoryRequest_Category = 2
	ItemCategoryRequest_FACEBOOK  ItemCategoryRequest_Category = 3
	ItemCategoryRequest_LINKEDIN  ItemCategoryRequest_Category = 4
	ItemCategoryRequest_TIKTOK    ItemCategoryRequest_Category = 5
	ItemCategoryRequest_PINTEREST ItemCategoryRequest_Category = 6
	ItemCategoryRequest_REDDIT    ItemCategoryRequest_Category = 7
	ItemCategoryRequest_SNAPCHAT  ItemCategoryRequest_Category = 8
	ItemCategoryRequest_TUMBLR    ItemCategoryRequest_Category = 9
	ItemCategoryRequest_TWITCH    ItemCategoryRequest_Category = 10
	ItemCategoryRequest_WEIBO     ItemCategoryRequest_Category = 11
	ItemCategoryRequest_WECHAT    ItemCategoryRequest_Category = 12
	ItemCategoryRequest_WHATSAPP  ItemCategoryRequest_Category = 13
	ItemCategoryRequest_LINE      ItemCategoryRequest_Category = 14
	ItemCategoryRequest_TELEGRAM  ItemCategoryRequest_Category = 15
	ItemCategoryRequest_VK        ItemCategoryRequest_Category = 16
	ItemCategoryRequest_YAHOO     ItemCategoryRequest_Category = 17
	ItemCategoryRequest_OTHER     ItemCategoryRequest_Category = 18
)

// Enum value maps for ItemCategoryRequest_Category.
var (
	ItemCategoryRequest_Category_name = map[int32]string{
		0:  "YOUTUBE",
		1:  "TWITTER",
		2:  "INSTAGRAM",
		3:  "FACEBOOK",
	...
	ItemCategoryRequest_Category_value = map[string]int32{
		"YOUTUBE":   0,
		"TWITTER":   1,
		"INSTAGRAM": 2,
		"FACEBOOK":  3,
...
func (x ItemCategoryRequest_Category) Enum() *ItemCategoryRequest_Category {
	p := new(ItemCategoryRequest_Category)
	*p = x
	return p
}

func (x ItemCategoryRequest_Category) String() string {
	return protoimpl.X.EnumStringOf(x.Descriptor(), protoreflect.EnumNumber(x))
}

func (ItemCategoryRequest_Category) Descriptor() protoreflect.EnumDescriptor {
	return file_item_proto_enumTypes[4].Descriptor()
}

func (ItemCategoryRequest_Category) Type() protoreflect.EnumType {
	return &file_item_proto_enumTypes[4]
}

func (x ItemCategoryRequest_Category) Number() protoreflect.EnumNumber {
	return protoreflect.EnumNumber(x)
}

// Deprecated: Use ItemCategoryRequest_Category.Descriptor instead.
func (ItemCategoryRequest_Category) EnumDescriptor() ([]byte, []int) {
	return file_item_proto_rawDescGZIP(), []int{9, 1}
}

type ItemCategoryRequest_SubCategory int32

const (
	ItemCategoryRequest_YOUTUBE_P ItemCategoryRequest_SubCategory = 0
)

// Enum value maps for ItemCategoryRequest_SubCategory.
var (
	ItemCategoryRequest_SubCategory_name = map[int32]string{
		0: "YOUTUBE_P",
	}
	ItemCategoryRequest_SubCategory_value = map[string]int32{
		"YOUTUBE_P": 0,
	}
)

func (x ItemCategoryRequest_SubCategory) Enum() *ItemCategoryRequest_SubCategory {
	p := new(ItemCategoryRequest_SubCategory)
	*p = x
	return p
}

func (x ItemCategoryRequest_SubCategory) String() string {
	return protoimpl.X.EnumStringOf(x.Descriptor(), protoreflect.EnumNumber(x))
}

func (ItemCategoryRequest_SubCategory) Descriptor() protoreflect.EnumDescriptor {
	return file_item_proto_enumTypes[5].Descriptor()
}

func (ItemCategoryRequest_SubCategory) Type() protoreflect.EnumType {
	return &file_item_proto_enumTypes[5]
}

func (x ItemCategoryRequest_SubCategory) Number() protoreflect.EnumNumber {
	return protoreflect.EnumNumber(x)
}

// Deprecated: Use ItemCategoryRequest_SubCategory.Descriptor instead.
func (ItemCategoryRequest_SubCategory) EnumDescriptor() ([]byte, []int) {
	return file_item_proto_rawDescGZIP(), []int{9, 2}
}
...
type ItemCategoryRequest struct {
	...
	Tool        []ItemCategoryRequest_Tool        `protobuf:"varint,3,rep,packed,name=tool,proto3,enum=item.ItemCategoryRequest_Tool" json:"tool,omitempty"`
	Category    []ItemCategoryRequest_Category    `protobuf:"varint,4,rep,packed,name=category,proto3,enum=item.ItemCategoryRequest_Category" json:"category,omitempty"`
	SubCategory []ItemCategoryRequest_SubCategory `protobuf:"varint,5,rep,packed,name=sub_category,json=subCategory,proto3,enum=item.ItemCategoryRequest_SubCategory" json:"sub_category,omitempty"`
}

func (x *ItemCategoryRequest) Reset() {
...
func (x *ItemCategoryRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*ItemCategoryRequest) ProtoMessage() {}

func (x *ItemCategoryRequest) ProtoReflect() protoreflect.Message {
	mi := &file_item_proto_msgTypes[9]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use ItemCategoryRequest.ProtoReflect.Descriptor instead.
func (*ItemCategoryRequest) Descriptor() ([]byte, []int) {
	return file_item_proto_rawDescGZIP(), []int{9}
}

func (x *ItemCategoryRequest) GetUserId() int64 {
	if x != nil {
		return x.UserId
	}
	return 0
...
func (x *ItemCategoryRequest) GetFreeWord() string {
	if x != nil {
		return x.FreeWord
	}
	return ""
...
func (x *ItemCategoryRequest) GetTool() []ItemCategoryRequest_Tool {
	if x != nil {
		return x.Tool
	}
	return nil
...
func (x *ItemCategoryRequest) GetCategory() []ItemCategoryRequest_Category {
	if x != nil {
		return x.Category
	}
	return nil
...
func (x *ItemCategoryRequest) GetSubCategory() []ItemCategoryRequest_SubCategory {
	if x != nil {
		return x.SubCategory
	}
	return nil
...
var file_item_proto_rawDesc = []byte{
	...
	0x28, 0x0a, 0x10, 0x49, 0x74, 0x65, 0x6d, 0x42, 0x6f, 0x6f, 0x6c, 0x52, 0x65, 0x73, 0x70, 0x6f,
	0x6e, 0x73, 0x65, 0x12, 0x14, 0x0a, 0x05, 0x65, 0x72, 0x72, 0x6f, 0x72, 0x18, 0x01, 0x20, 0x01,
	0x28, 0x08, 0x52, 0x05, 0x65, 0x72, 0x72, 0x6f, 0x72, 0x22, 0xe1, 0x04, 0x0a, 0x13, 0x49, 0x74,
	...
	,
...
var file_item_proto_goTypes = []interface{}{
	...
	(ItemCategoryRequest_Tool)(0),        // 3: item.ItemCategoryRequest.Tool
	(ItemCategoryRequest_Category)(0),    // 4: item.ItemCategoryRequest.Category
	(ItemCategoryRequest_SubCategory)(0), // 5: item.ItemCategoryRequest.SubCategory
	...
	(*ItemBoolResponse)(nil),             // 14: item.ItemBoolResponse
	(*ItemCategoryRequest)(nil),          // 15: item.ItemCategoryRequest
...
var file_item_proto_depIdxs = []int32{
	...
	16, // 3: item.Item.like:type_name -> like.Like
	...
	3,  // 8: item.ItemCategoryRequest.tool:type_name -> item.ItemCategoryRequest.Tool
	4,  // 9: item.ItemCategoryRequest.category:type_name -> item.ItemCategoryRequest.Category
	5,  // 10: item.ItemCategoryRequest.sub_category:type_name -> item.ItemCategoryRequest.SubCategory
	...
	12, // 15: item.ItemService.GetListByUser:input_type -> item.ItemIdRequest
	15, // 16: item.ItemService.GetListByCategory:input_type -> item.ItemCategoryRequest
	12, // 17: item.ItemService.GetLatestList:input_type -> item.ItemIdRequest
	12, // 18: item.ItemService.GetTrendList:input_type -> item.ItemIdRequest
	12, // 19: item.ItemService.GetRecommendedListByUser:input_type -> item.ItemIdRequest
	12, // 20: item.ItemService.GetSoldListByUser:input_type -> item.ItemIdRequest
	12, // 21: item.ItemService.GetPurchasedListByUser:input_type -> item.ItemIdRequest
	12, // 22: item.ItemService.GetLikedListByUser:input_type -> item.ItemIdRequest
	13, // 23: item.ItemService.GetListByIdList:input_type -> item.ItemIdListRequest
	17, // 24: item.ItemService.GetAll:input_type -> google.protobuf.Empty
	6,  // 25: item.ItemService.Create:output_type -> item.Item
	14, // 26: item.ItemService.Update:output_type -> item.ItemBoolResponse
	14, // 27: item.ItemService.Delete:output_type -> item.ItemBoolResponse
	6,  // 28: item.ItemService.GetById:output_type -> item.Item
	11, // 29: item.ItemService.GetListByUser:output_type -> item.ItemList
	11, // 30: item.ItemService.GetListByCategory:output_type -> item.ItemList
...
func file_item_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_item_proto_msgTypes[9].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*ItemCategoryRequest); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
